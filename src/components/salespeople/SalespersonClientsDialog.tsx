...
export function SalespersonClientsDialog({
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-[700px] max-h-[80vh] overflow-y-auto border-border-dark bg-surface-dark text-white">
                <DialogHeader>
                ...
                {isLoading ? (
                    ...
                    <div className="text-center py-12">
                        ...
                        <p className="text-gray-400">Žiadni priradení klienti</p>
                    </div>
                ) : (
                    <div>
                        ...
                        <Table>
                            <TableHeader>
                                <TableRow className="border-border-dark hover:bg-transparent">
                                    ...
                                    <TableHead className="text-right text-gray-400">Hodnota</TableHead>
                                </TableRow>
                            </TableHeader>
                            <TableBody>
                                {clients.map(client => (
                                    <TableRow key={client.id} className="border-border-dark hover:bg-white/5 text-white">
                                        <TableCell>
                                            <div>
